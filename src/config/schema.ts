...
const POLICY_FIELDS: ConfigField[] = [
  ...
  { key: 'orderbookFreshnessMs', label: 'Orderbook Freshness', type: 'number', min: 10, max: 10000, step: 10, unit: 'ms', integer: true },
  ...
  { key: 'maxBookStalenessMs', label: 'Max Book Staleness', type: 'number', min: 100, max: 5000, step: 10, unit: 'ms', integer: true },
